...
RUN npm install --location=global astra-setup-linkedin axios node-jq
...
RUN url https://downloads.datastax.com/enterprise/cqlsh-astra-20201104-bin.tar.gz --output /home/gitpod/cqlsh-astra.tar.gz
